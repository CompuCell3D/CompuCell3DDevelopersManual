...
.. note::
    ...
    Starting from version ``4.3.0`` of CC3D the DeveloperZone compilation setup (for any compiler) is is done
automatically.
All you need to do is to follow procedure outlined in `Configuring Developer Zone <configuring_developer_zone.html>`_
